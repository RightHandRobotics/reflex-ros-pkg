...
static uint8_t  g_eth_src_mac[6] = { 0xa4, 0xf3, 0xc1, 0x00, 0x01, 0x00 }; // alyssa's was { 0xae, 0xf3, 0xc1, 0x00, 0x01, 0x11 }
static uint32_t g_eth_src_ip = 0x0a636362; // todo... not this.
...
static bool eth_dispatch_udp(const uint8_t *data, const uint16_t len)
{
  ...
  */
  if (port == DEST_PORT_NUM && payload_len > 0)
  {
