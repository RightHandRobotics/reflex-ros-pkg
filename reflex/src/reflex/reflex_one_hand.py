...
from reflex_hand_5_motors_ref1 import ReflexHand
from reflex_one_motor import ReflexOneMotor
import reflex_msgs.msg

from dynamixel_driver import dynamixel_io     ### Added this to set IDs
...
motor, or 'q' to indicate that the zero point has been reached\n")
    ...
    def _write_zero_point_data_to_file(self, filename, data):
        ...
        reflex_one_path = rospack.get_path("reflex")
        yaml_path = "yaml"
        file_path = join(reflex_one_path, yaml_path, filename)
